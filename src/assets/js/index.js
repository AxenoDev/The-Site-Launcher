...
const activity = {
  details: "The Site Launcher",
  assets: {
    large_image: "image_1",
    small_image: "image_1",
    large_text: "The Site Launcher",
    small_text: "The Site Launcher, Serveur minecraft Moddé, RP, ouvert à tous !"
  },
  buttons: [
    {
      label: "DISCORD",
      url: "https://discord.gg/cRSw4gTpA3"
    }
  ],
...
client.login({ clientId: "985457358639616062" });
...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "Re...Re...Recherche", "author": "Axeno" },
            { "message": "Merci de jouer sur The Site", "author": "Axeno" }
        ];
